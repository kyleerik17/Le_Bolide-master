...
class OutillagePage extends StatefulWidget {
  final String categoryId;

  const OutillagePage({Key? key, required this.categoryId, required Map<String, dynamic> categoryDetails}) : super(key: key);

  @override
  _OutillagePageState createState() => _OutillagePageState();
}

class _OutillagePageState extends State<OutillagePage> {
