...
class HuileMoteurPage extends StatefulWidget {
  final String categoryId;

  const HuileMoteurPage({Key? key, required this.categoryId, required Map<String, dynamic> categoryDetails}) : super(key: key);

  @override
  _HuileMoteurPageState createState() => _HuileMoteurPageState();
}

class _HuileMoteurPageState extends State<HuileMoteurPage> {
