...
class AccessoireAutoPage extends StatefulWidget {
  final String categoryId;

  const AccessoireAutoPage({Key? key, required this.categoryId, required Map<String, dynamic> categoryDetails}) : super(key: key);

  @override
  _AccessoireAutoPageState createState() => _AccessoireAutoPageState();
}

class _AccessoireAutoPageState extends State<AccessoireAutoPage> {
                  ...
                  children: [
                    TextButton(
                      style: TextButton.styleFrom(
                        backgroundColor: _selectedButton == 'Tout' ? Colors.black : Colors.white,
                      ...
                      child: Text(
                        'Tout',
                        style: TextStyle(
                          color: _selectedButton == 'Tout' ? Colors.white : Colors.black,
                        ),
                      ),
                    ),
                    Gap(2.w),
